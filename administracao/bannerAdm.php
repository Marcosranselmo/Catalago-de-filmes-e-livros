                ...
                <form name="fmBanner" method="post" action="bannerAdm.php" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <img src="../imagens/banner/sem_imagem.jpg" class="img-responsive img-thumbnail">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" name="<?php echo "txtLinkBanner".$i ?>" class="form-control" placeholder="Link utilizado no banner"><br>

                            <label><strong>Descrição do Banner:</strong></label>
                            <input type="text" name="<?php echo "txtDescricaoBanner".$i ?>" class="form-control" placeholder="
