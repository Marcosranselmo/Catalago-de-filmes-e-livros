                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    ?>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="#tabExibicao" class="nav-link" id="linkExibicao" data-toggle="tab" role="tab" aria-controls="tabExibicao">Atores/Atrizes Cadastrados</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="meusConteudos">
                            ...
                            <div class="tab-pane fade mt-5" id="tabExibicao" role="tabpanel" aria-labelledby="linkExibicao">
